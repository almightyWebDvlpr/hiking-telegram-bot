...
const SAFETY_PROFILES = [
  ...
  },
  {
    ...
    keywords: ["славське", "парашка", "сколе", "сколе", "львів", "тростян", "майдан", "корчин", "сколівські бескиди", "камянка", "кам'янка", "журавлине", "менчил"],
    contacts: [
      {
  ...
  },
  {
    ...
    keywords: ["вижниця", "чернівці", "путила", "буковина", "черемош", "смугарі", "сокільський", "яловичора", "томнатик", "чивчини", "піп іван мармароський", "мармароси"],
    contacts: [
      {
