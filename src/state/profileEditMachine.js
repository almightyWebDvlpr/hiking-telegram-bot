...
export const PROFILE_EDIT_STEPS = [
  ...
  "backupEmergencyContactEnabled",
  "backupEmergencyContactName",
  "backupEmergencyContactPhone",
  "backupEmergencyContactRelation",
  "experienceLevel",
  "city",
  "passportNumber",
  "passportIssuedBy"
...
export const profileEditMachine = createMachine({
  ...
  states: {
    ...
    emergencyContactRelation: { on: { NEXT: "backupEmergencyContactEnabled", BACK: "emergencyContactPhone" } },
    backupEmergencyContactEnabled: { on: { NEXT: "backupEmergencyContactName", BACK: "emergencyContactRelation" } },
    backupEmergencyContactName: { on: { NEXT: "backupEmergencyContactPhone", BACK: "backupEmergencyContactEnabled" } },
    backupEmergencyContactPhone: { on: { NEXT: "backupEmergencyContactRelation", BACK: "backupEmergencyContactName" } },
    backupEmergencyContactRelation: { on: { NEXT: "experienceLevel", BACK: "backupEmergencyContactPhone" } },
    experienceLevel: { on: { NEXT: "city", BACK: "backupEmergencyContactRelation" } },
