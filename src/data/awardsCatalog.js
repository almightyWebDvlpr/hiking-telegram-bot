...
export const BADGE_SERIES = [
  ...
  },
  {
    ...
    title: "Маршрутник",
    milestones: [
      { tier: "bronze", threshold: 1, description: "1 похід із підтвердженим маршрутом" },
      { tier: "silver", threshold: 5, description: "5 походів із підтвердженим маршрутом" },
      { tier: "gold", threshold: 12, description: "12 походів із підтвердженим маршрутом" },
      { tier: "crystal", threshold: 25, description: "25 походів із підтвердженим маршрутом" },
      { tier: "diamond", threshold: 50, description: "50 походів із підтвердженим маршрутом" }
    ]
  },
  {
    key: "gearRequestsClosed",
    icon: "🤝",
    title: "Помічник команди",
    milestones: [
      { tier: "bronze", threshold: 1, description: "1 закритий запит на спорядження" },
      { tier: "silver", threshold: 5, description: "5 закритих запитів на спорядження" },
      { tier: "gold", threshold: 15, description: "15 закритих запитів на спорядження" },
...
export const ONE_TIME_AWARDS = {
  ...
  first_route_ready: {
    icon: "🗺️",
    title: "Маршрут готовий",
    description: "Перший похід із повністю збереженим маршрутом"
  },
  first_gear_helper: {
    icon: "🤝",
    title: "Перша допомога команді",
    description: "Вперше закрито чужий запит на спорядження"
  },
  first_critical_ready: {
    icon: "📦",
    title: "База закрита",
    description: "Перший похід із закритим критичним спорядженням"
  },
  first_trip_lender: {
    icon: "🧰",
    title: "Позичив у дорогу",
    description: "Вперше передано свою річ іншому учаснику"
  }
};
...
export const AWARD_RULES_OVERVIEW = [
  ...
  "• 🥉 / 🥈 / 🥇 / 💠 / 💎 `Маршрутник` — 1 / 5 / 12 / 25 / 50 походів із підтвердженим маршрутом",
  "• 🥉 / 🥈 / 🥇 / 💠 / 💎 `Помічник команди` — 1 / 5 / 15 / 30 / 60 закритих запитів на спорядження",
  "• 🥉 / 🥈 / 🥇 / 💠 / 💎 `Готові до старту` — 1 / 3 / 7 / 15 / 30 походів із закритим критичним спорядженням",
  ...
  "• 🗺️ `Маршрут готовий` — за перший повністю збережений маршрут",
  "• 🤝 `Перша допомога команді` — за перший закритий чужий запит на спорядження",
  "• 📦 `База закрита` — за перший похід із повністю закритим критичним спорядженням",
  "• 🧰 `Позичив у дорогу` — за першу передачу своєї речі іншому учаснику"
];
...
export const MANUAL_AWARDS_OVERVIEW = [
  ...
  "• 🧠 `Холодна голова` — за спокійні рішення в стресовий момент",
  "• 🗺️ `Тримає нитку` — за чітке ведення групи по маршруту",
  "• 🌧️ `Не зламався під дощем` — за витримку і дисципліну в мокрий день",
  "• 🎒 `Майстер пакування` — за продумане спорядження і порядок у рюкзаку",
  "• 🔋 `Енергетик групи` — за зарядки, павербанки і технічну підтримку"
];
