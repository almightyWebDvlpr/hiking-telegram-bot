...
const GEAR_NAME_ALIASES = [
  ...
  { canonical: "GPS-навігатор", keywords: ["gps", "джіпіес", "навігатор", "garmin", "etrex", "gpsmap", "туристичний навігатор", "ручний gps", "окремий gps"] },
  { canonical: "Карта в телефоні", keywords: ["карта в телефоні", "карта в смартфоні", "карта в мобільному", "карта в мобільному телефоні", "смартфон з картою", "телефон з картою", "офлайн карта в телефоні", "офлайн карта на телефоні", "офлайн мапа в телефоні", "мапа в телефоні", "мапа в смартфоні", "карта в моб телефоні", "телефон з офлайн картою", "смартфон з офлайн картою", "трек у телефоні", "маршрут у телефоні", "mapy cz", "mapy.cz", "organic maps", "locus map", "gaia gps", "komoot"] },
  { canonical: "GPS-годинник", keywords: ["gps годинник", "gps-годинник", "смартгодинник з картою", "годинник з картою", "garmin fenix", "garmin forerunner", "garmin instinct", "apple watch ultra", "suunto", "coros"] },
  ...
  { canonical: "Аптечка", keywords: ["аптечка", "аптечка групова", "похідна аптечка", "first aid", "first aid kit", "медичний набір"] },
  ...
  { canonical: "Павербанк", keywords: ["павербанк", "повербанк", "powerbank", "банк живлення", "зовнішній акумулятор"] },
  { canonical: "Сонячна панель", keywords: ["сонячна панель", "solar panel"] },
  { canonical: "Ремнабір", keywords: ["ремнабір", "ремкомплект", "ремонтний набір", "repair kit", "набір для ремонту"] },
  ...
  { canonical: "Мембранна куртка", keywords: ["мембранна куртка", "мембрана", "хардшел", "штормова куртка", "shell jacket"] },
  ...
  { canonical: "Шкарпетки", keywords: ["шкарпетки", "шкарпетка", "носки", "трекінгові шкарпетки", "запасні шкарпетки"] },
  { canonical: "Окуляри", keywords: ["окуляри", "сонцезахисні окуляри", "glasses", "sunglasses"] },
  { canonical: "Сонцезахисний крем", keywords: ["сонцезахисний крем", "spf", "spf крем", "сонцезахист", "крем від сонця"] },
  { canonical: "Репелент", keywords: ["репелент", "спрей від комах", "засіб від комарів", "засіб від кліщів", "anti mosquito", "tick spray"] },
  { canonical: "Зубна щітка", keywords: ["зубна щітка", "щітка для зубів", "toothbrush"] },
  { canonical: "Зубна паста", keywords: ["зубна паста", "паста для зубів", "toothpaste"] },
  { canonical: "Мило", keywords: ["мило", "soap", "рідке мило", "сухе мило"] },
  { canonical: "Вологі серветки", keywords: ["вологі серветки", "серветки", "wet wipes"] },
  { canonical: "Туалетний папір", keywords: ["туалетний папір", "туалетка", "toilet paper"] },
  { canonical: "Антисептик для рук", keywords: ["антисептик для рук", "санітайзер", "hand sanitizer"] },
  { canonical: "Аварійне покривало", keywords: ["аварійне покривало", "термоковдра", "рятувальне покривало", "space blanket", "emergency blanket", "аварійний біві"] },
  { canonical: "Каска", keywords: ["каска", "шолом", "альп каска", "climbing helmet"] },
...
export const GEAR_CATEGORIES = [
  ...
  },
  {
    ...
    label: "Гігієна",
    keywords: [
      "гігієн", "гігієна", "мило", "soap", "щітка", "зубна щітка", "паста", "зубна паста",
      "серветк", "вологі серветки", "туалетний папір", "санітайзер", "антисептик для рук",
      "дезінфектор для рук", "рушник", "мікрофібровий рушник", "косметичка", "тревел набір"
    ]
  },
  {
    key: "navigation",
...
export const GEAR_PROFILES = [
  ...
  },
  {
    ...
    keywords: [
      ...
      "mapy cz", "organic maps", "locus map", "gaia gps", "komoot", "alltrails",
      "gps годинник", "gps-годинник", "смартгодинник", "смарт годинник", "годинник з картою",
      "garmin fenix", "garmin forerunner", "suunto", "coros", "apple watch", "garmin watch"
    ],
    fields: [
      {
        key: "navType",
  ...
  },
  {
    ...
    keywords: [
      ...
      "satellite messenger", "garmin inreach", "starlink mini", "супутниковий зв'язок"
    ],
    fields: [
      {
  ...
  },
  {
    ...
    keywords: [
      "гігієна", "мило", "soap", "щітка", "зубна щітка", "toothbrush", "паста", "toothpaste",
      "серветки", "вологі серветки", "туалетний папір", "санітайзер", "антисептик для рук",
      "рушник", "мікрофібровий рушник", "travel kit", "тревел набір"
    ],
    fields: [
      {
        key: "hygieneType",
        label: "Тип",
        prompt: "Вкажи тип.\nПриклад: `зубна щітка`, `мило`, `серветки`, `рушник`.",
        type: "text_optional"
      },
      {
        key: "capacityMl",
        label: "Обʼєм / розмір",
        prompt: "Вкажи обʼєм або розмір.\nПриклад: `50 мл`, `100 мл`, `малий рушник`.",
        type: "text_optional"
      },
      COMMON_FIELDS[0],
      COMMON_FIELDS[1]
  ...
  },
  {
    ...
    keywords: [
      ...
      "duct tape", "армований скотч", "стяжки", "zip tie", "zip ties", "голка з ниткою", "набір латок"
    ],
    fields: [
      {
        key: "repairType",
  ...
  {
    key: "emergency_kit",
    label: "Аварійний набір",
    keywords: [
      "аварійне покривало", "термоковдра", "рятувальне покривало", "space blanket", "emergency blanket",
      "аварійний біві", "emergency bivy", "сигнальне дзеркало", "хімічне світло", "свисток",
      "аварійний набір", "survival kit", "набір виживання"
    ],
    fields: [
      {
        key: "emergencyType",
        label: "Тип",
        prompt: "Вкажи тип.\nПриклад: `термоковдра`, `аварійний біві`, `набір виживання`.",
        type: "text_optional"
      },
      {
        key: "purpose",
        label: "Призначення",
        prompt: "Для чого це?\nПриклад: `аварійне утеплення`, `сигнал`, `резерв безпеки`.",
        type: "text_optional"
      },
      COMMON_FIELDS[0],
      COMMON_FIELDS[1]
