...
const GEAR_NAME_ALIASES = [
  ...
  { canonical: "Шкарпетки", keywords: ["шкарпетки", "шкарпетка", "носки", "трекінгові шкарпетки", "запасні шкарпетки"] },
  {
    canonical: "Окуляри",
    keywords: [
      "окуляри", "окуляр", "коляри", "сонцезахисні окуляри", "сонцезахисні",
      "сонячні окуляри", "окуляри від сонця", "спортивні окуляри", "туристичні окуляри",
      "трекінгові окуляри", "велосипедні окуляри", "велоокуляри", "бігові окуляри",
      "льодовикові окуляри", "glasses", "sunglasses", "sports glasses", "trail glasses"
    ]
  },
  {
    canonical: "Лижна маска",
    keywords: [
      "лижна маска", "гірськолижна маска", "сноубордична маска", "маска", "маска для очей",
      "маска лижна", "snow goggles", "ski goggles", "goggles", "захисна маска для очей"
    ]
  },
  {
    canonical: "Захисні окуляри",
    keywords: [
      "захисні окуляри", "тактичні окуляри", "тактичка на очі", "балістичні окуляри",
      "прозорі окуляри", "окуляри захисні", "eyewear", "protective glasses"
    ]
  },
  {
    canonical: "Контактні лінзи",
    keywords: [
      "лінзи", "контактні лінзи", "контактні", "contact lenses", "линзы"
    ]
  },
  {
    canonical: "Футляр для окулярів",
    keywords: [
      "футляр для окулярів", "чохол для окулярів", "кейс для окулярів", "hard case glasses"
    ]
  },
  { canonical: "Беруші", keywords: ["беруші", "беруши", "earplugs", "затички для вух"] },
  { canonical: "Маска для сну", keywords: ["маска для сну", "маска на очі", "sleep mask"] },
  { canonical: "Годинник", keywords: ["годинник", "наручний годинник", "watch", "спортивний годинник"] },
...
export const GEAR_CATEGORIES = [
  ...
  },
  {
    ...
    keywords: [
      ...
      "баф", "бафф", "горловик",
      "окуляр", "окуляри", "коляри", "сонцезахисн", "велоокуляр", "лижна маска", "гірськолижна маска",
      "захисні окуляри", "тактичні окуляри", "лінзи", "контактні лінзи", "футляр для окулярів",
      "гамаш", "бахіли",
...
export const GEAR_PROFILES = [
  ...
  {
    key: "eyewear",
    label: "Окуляри / захист очей",
    keywords: [
      "окуляри", "окуляр", "коляри", "сонцезахисні окуляри", "сонячні окуляри",
      "спортивні окуляри", "трекінгові окуляри", "велосипедні окуляри", "велоокуляри",
      "льодовикові окуляри", "лижна маска", "гірськолижна маска", "snow goggles", "ski goggles",
      "захисні окуляри", "тактичні окуляри", "балістичні окуляри", "контактні лінзи", "лінзи",
      "футляр для окулярів", "чохол для окулярів"
    ],
    fields: [
      {
        key: "eyewearType",
        label: "Тип",
        prompt: "Вкажи тип.\nПриклад: `сонцезахисні окуляри`, `лижна маска`, `захисні окуляри`, `контактні лінзи`.",
        type: "text_optional"
      },
      {
        key: "lensType",
        label: "Лінза / захист",
        prompt: "Вкажи тип лінзи або рівень захисту.\nПриклад: `UV400`, `категорія 3`, `прозора`, `жовта`, `фотохромна`.",
        type: "text_optional"
      },
      {
        key: "purpose",
        label: "Призначення",
        prompt: "Для чого береш?\nПриклад: `сонце`, `вітер`, `сніг`, `каміння`, `щоденне носіння`.",
        type: "text_optional"
      },
      COMMON_FIELDS[0],
      COMMON_FIELDS[1]
