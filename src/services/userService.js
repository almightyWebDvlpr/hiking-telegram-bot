...
function buildProfileSnapshot(user, userName = "") {
  ...
  return {
    ...
    backupEmergencyContactEnabled: normalizeText(profile.backupEmergencyContactEnabled),
    backupEmergencyContactName: normalizeText(profile.backupEmergencyContactName),
    backupEmergencyContactPhone: normalizePhone(profile.backupEmergencyContactPhone),
